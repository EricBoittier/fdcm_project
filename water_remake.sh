...
scan_name=angle_
suffix=_new.com.chk
cubes_dir=/home/unibas/boittier/water_model/cubes/angle
output_dir=/data/unibas/boittier/water_remake_2
...
$fdcm -xyz refined.xyz.global -dens $dens -esp  $esp -stepsize 0.2 -n_steps 10 -learning_rate 0.5 > GD.log
# re adjust to local
