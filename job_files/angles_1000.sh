...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home/boittier/FDCM/out_files/water_angle_1000.out
hostname
...
time $pcubex -xyz global_6_fit.xyz -dens $cubes_dir/"angle_6_new.com.chk.fchk.d.cube" -esp  $cubes_dir/"angle_6_new.com.chk.fchk.p.cube" -stepsize 0.2 -n_steps $n_steps -learning_rate 0.5 > "GD.log"
