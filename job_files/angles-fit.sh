...
$olivers_code -v -generate -esp  $cubes_dir/"angle_6_new.com.chk.fchk.p.cube" -dens  $cubes_dir/"angle_6_new.com.chk.fchk.d.cube" -xyz global_fitted_global.xyz > "cubemaking.log"
