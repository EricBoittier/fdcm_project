#!/bin/bash
#SBATCH --job-name=/data/unibas/boittier/morton_1_25
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
output_dir=/data/unibas/boittier/morton_1_25
...
for next in 1 17 16 2 15 5 4 6 7 12 13 11 10 3 8 14 9 18 19 35 34 20 33 23 22 24 25 30 31 29 28 21 26 32 27
do
