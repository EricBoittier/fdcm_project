...
echo $initial_fit $initial_fit_cube".com.chk.d.cube"  $cubes_dir/"angle_6_new.com.chk.fchk.p.cube" $frames 0_fit.xyz

python ~/AdjustReference-System/ARS.py $initial_fit $initial_fit_cube".com.chk.d.cube"  $cubes_dir/"angle_6_new.com.chk.fchk.p.cube" $frames 0_fit.xyz > "ARS.log"
# do gradient descent fit
time ../cubefit.x -xyz global_0_fit.xyz -dens $cubes_dir/"angle_6_new.com.chk.fchk.d.cube" -esp  $cubes_dir/"angle_6_new.com.chk.fchk.p.cube" -stepsize 0.2 -n_steps $n_steps -learning_rate 0.5 > "GD.log"
