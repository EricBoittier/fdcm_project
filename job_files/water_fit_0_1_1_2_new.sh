#!/bin/bash
#SBATCH --job-name=water_fit_0_1_1_2_new
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home/boittier/FDCM/out_files/water_fit_0_1_1_2_new.out
hostname
...
output_dir="water_fit_0_1_1_2_new"
frames="/home/boittier/v1/frames.txt"
initial_fit="/home/boittier/FDCM/water_fit/2_2_2/global_fitted_global.xyz"
