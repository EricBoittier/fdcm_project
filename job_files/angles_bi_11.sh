...
echo $initial_fit $initial_fit_cube".com.chk.d.cube"  $cubes_dir/"angle_11_6_new.com.chk.p.cube" $frames 6_fit.xyz

python ~/AdjustReference-System/ARS.py $initial_fit $initial_fit_cube".com.chk.d.cube"  $cubes_dir/"angle_11_6_new.com.chk.p.cube" $frames 6_fit.xyz > "ARS.log"

# do gradient descent fit
time $pcubex -xyz global_6_fit.xyz -dens $cubes_dir/"angle_11_6_new.com.chk.d.cube" -esp  $cubes_dir/"angle_11_6_new.com.chk.p.cube" -stepsize 0.2 -n_steps $n_steps -learning_rate 0.5 > "GD.log"

python ~/AdjustReference-System/ARS.py refined.xyz $cubes_dir/"angle_11_6_new.com.chk.p.cube"  $cubes_dir/"angle_11_6_new.com.chk.p.cube" $frames 6_fit.xyz > "ARS.log"

# make a cubefile for the fit
$olivers_code -v -generate -esp  $cubes_dir/"angle_11_6_new.com.chk.p.cube" -dens  $cubes_dir/"angle_11_6_new.com.chk.d.cube" -xyz refined.xyz > "cubemaking.log"
