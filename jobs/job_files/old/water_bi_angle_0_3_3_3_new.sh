#!/bin/bash
#SBATCH --job-name=water_bi_angle_0_3_3_3_new
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home/boittier/FDCM/out_files/water_bi_angle_0_3_3_3_new.out
hostname
...
output_dir="water_bi_angle_0_3_3_3_new"
