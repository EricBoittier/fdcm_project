...
frames="/home/boittier/pydcm/models/amide1/frames.txt"
initial_fit="/home/boittier/pydcm/models/amide1/5-refine/20-charges/20_charges_refined.xyz"
initial_fit_cube="/home/boittier/amide/OPT_B3LYP_6-311++G**/amide1.pdb.chk"

starting_frame=0
first_fit=$cubes_dir/"1_1_new-"$starting_frame.chk
...
startd="1_1_new-"$start".chk.d.cube"
startp="1_1_new-"$start".chk.p.cube"
nextd="1_1_new-"$next".chk.d.cube"
nextp="1_1_new-"$next".chk.p.cube"
