#!/bin/bash
#SBATCH --job-name=water_bi_angle_0_2_3_2_new
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=/home/boittier/FDCM/out_files/water_bi_angle_0_2_3_2_new.out
hostname
...
output_dir="water_bi_angle_0_2_3_2_new"
