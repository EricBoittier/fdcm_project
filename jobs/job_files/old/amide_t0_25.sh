#!/bin/bash
#SBATCH --job-name=/data/unibas/boittier/amide_scan_t0_25
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --partition=short
#SBATCH --output=/home/unibas/boittier/FDCM/out_files/frame__%A-%a.out
...
scan_name=frame_
suffix=.chk
cubes_dir=/data/unibas/boittier/ts/t0
output_dir=/data/unibas/boittier/amide_scan_t0_25
