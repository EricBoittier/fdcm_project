#!/bin/bash
#SBATCH --job-name=/data/unibas/boittier/formamide2000
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
output_dir=/data/unibas/boittier/formamide2000
frames=/home/unibas/boittier/fdcm_project/mdcms/formamide/frames.txt
initial_fit=/home/unibas/boittier/fdcm_project/mdcms/formamide/12charges.xyz
initial_fit_cube=/data/unibas/boittier/models/formamide/scan/scan0
morton_start=21
acd=/data/unibas/boittier/formamide2000/frame_21/out.acd.acd
