#!/bin/bash
#SBATCH --job-name=/data/unibas/boittier/dimethylether200
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
scan_name=scan
suffix=
cubes_dir=/data/unibas/boittier/models/dimethylether/scan2
output_dir=/data/unibas/boittier/2dimethylether200
frames=/home/unibas/boittier/fdcm_project/mdcms/dimethylether/frames.txt
initial_fit=/home/unibas/boittier/fdcm_project/mdcms/dimethylether/14charges.xyz
initial_fit_cube=/data/unibas/boittier/models/dimethylether/scan/scan0
morton_start=21
acd=/data/unibas/boittier/dimethylether200/frame_21/out.acd.acd
