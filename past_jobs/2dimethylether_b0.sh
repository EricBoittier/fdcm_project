#!/bin/bash
#SBATCH --job-name=/data/unibas/boittier/dimethylether0
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
output_dir=/data/unibas/boittier/2dimethylether0
...
morton_start=21
acd=/data/unibas/boittier/2dimethylether0/frame_21/out.acd.acd
